...
namespace PaperCut
{
	...
	public class ServerCommandProxyService : IServerCommandOperations
    {
		...
		public List<string> GetAllUsers()
        {
            ...
            {
				_logger.LogError("Error getting users. Returning empty list. Error details {error}", e.ToString());
        ...
        List<string> IServerCommandOperations.GetAllPrinters()
        {
            ...
            {
                _logger.LogError("Error getting printers. Returning empty list. Error details {error}", e.ToString());
                return new List<string>();
            }
		}
        ...
        List<string> IServerCommandOperations.GetAllSharedAccounts()
        {
            ...
            {
                _logger.LogError("Error getting shared accounts. Returning empty list. Error details {error}", e.ToString());
                return new List<string>();
            }
		}
